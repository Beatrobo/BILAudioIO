...
{
    BILAudioOutput* audioOutput = (__bridge BILAudioOutput*)inRefCon;
...
{
    if (_isConfigured) {
        [BILAudio checkResult:AudioOutputUnitStop(_outputUnit)
                    operation:"Failed to uninitialize output unit"];
        
        [BILAudio checkResult:AudioUnitUninitialize(_outputUnit)
                    operation:"Failed to uninitialize output unit"];
        
        [BILAudio checkResult:AudioComponentInstanceDispose(_outputUnit)
                    operation:"Failed to uninitialize output unit"];
    }
}
...
- (void)startPlayback
{
    if (_isConfigured) {
        if (!_isPlaying) {
            [BILAudio checkResult:AudioOutputUnitStart(_outputUnit)
...
- (void)setAudioStreamBasicDescription:(AudioStreamBasicDescription)audioStreamBasicDescription
{
    ...
    [BILAudio checkResult:AudioUnitSetProperty(_outputUnit,
...
- (void)configureOutput
{
    ...
    [BILAudio checkResult:AudioComponentInstanceNew(comp, &_outputUnit)
    ...
    _outputASBD = [BILAudio physicalOutputWithSampleRate:hardwareSampleRate];
    ...
    [BILAudio checkResult:AudioUnitInitialize(_outputUnit)
...
- (void)configureOutput
{
    ...
    _outputASBD = [BILAudio physicalOutputWithSampleRate:44100];
